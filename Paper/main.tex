...
\begin{document}
	...
	We can plot another $y(t)$ where $k$ is much smaller which should result in our object not reaching it's terminal velocity in such short time. The following measurements are from a small steel ball with $k = 0.00313$.
	\begin{align}\nonumber
		\begin{cases}\nonumber
			C_D &= 0.47 \\
			m &= 0.022\,kg\\
